    ...
    <ModalAsset :isVisible="showModalEditAsset" @close="closeEditAssetModal">
      <div class="px-2 py-2">
        ...
        <div class="">
          ...
          <div class="flex justify-center">
            <button type="button" @click="saveEditScrappedAsset" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium focus:outline-none bg-green-700 rounded-lg border hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 text-white">SAVE</button>
