        ...
        <div class="">
          ...
          <div class="flex justify-between gap-1 items-center">
            ...
            <div class="text-center">
              <button @click="transferAssetOut" class="bg-green-700 text-white text-[14px] my-1 px-4 py-1 rounded-md font-semibold hover:scale-105 duration-300">
                TRANSFER
              </button>
              <button @click="closeAssetModal" class="bg-red-700 text-white text-[14px] my-1 px-[24px] py-1 rounded-md font-semibold hover:scale-105 duration-300">
                CANCEL
              </button>
            </div>
          </div>
    ...
    <ModalAsset :isVisible="showModalEditAsset" @close="closeEditAssetModal">
      <div class="px-2 py-2">
        ...
        <div class="">
          ...
          <div class="flex justify-center">
            <button type="button" @click="saveEditAssetOut" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium focus:outline-none bg-green-700 rounded-lg border hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 text-white hover:scale-105 duration-300">SAVE</button>
            
          </div>
        </div>
      </div>
    </ModalAsset>
    <div class="absolute w-[78%] h-[30%] min-h-[540px] left-[350px] top-[210px] bg-white z-40 opacity-50 rounded-md" :class="showModalAsset || showModalEditAsset ? 'block' : 'hidden'"></div>
