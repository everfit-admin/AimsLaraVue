<template>
  ...
  <script>
  import DeviceCardAssetOut from './DeviceCardAssetOut.vue';
  
  export default {
    components: { DeviceCardAssetOut },
    data() {
      return {
        devices: [
          { id: 1, name: "Ryzen 5 3600", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
          { id: 2, name: "Dell Latitude 234", serialNumber: "243432KJKA2", owner: "N/A", status: "Unassigned" },
          { id: 3, name: "Ryzen 7 4100", serialNumber: "0034JKLDFJ3", owner: "Juan Antonio Gonzales", status: "Assigned" },
          { id: 4, name: "BenQ 19", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
          { id: 4, name: "BenQ 19", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
          { id: 4, name: "BenQ 19", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
          { id: 4, name: "BenQ 19", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
          { id: 4, name: "BenQ 19", serialNumber: "56485FDGS", owner: "Jeff Orilla", status: "Assigned" },
