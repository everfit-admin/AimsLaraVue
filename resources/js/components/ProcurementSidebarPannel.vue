    ...
    <div class="bg-black h-[100%] text-white w-[45px] pt-[41px] transition-all duration-500 ease-in-out transform z-20">
      <div class="flex justify-center">
        <div>
          ...
          <div class="py-[7px]">
            <router-link to="/purcha">
              <img src="./images/icon-supplier.png" class="w-[30px]" alt="maintenance icon">
            </router-link>
          </div>
          <div class="py-[4px]">
            <router-link to="/purcha">
              <img src="./images/icon-receipt.png" class="w-[30px]" alt="point of sale icon">
            </router-link>
          </div>
          <div class="py-[12px]">
            <router-link to="/budge">
              <img src="./images/icon-check.png" class="w-[30px]" alt="knowledge icon">
            </router-link>
          </div>
        </div>
      </div>
      ...
      <div class="bg-gray h-[100%] duration-500 border-r border-black group-hover:w-[220px] w-[290px] -translate-x-[500px] group-hover:translate-x-0 absolute top-0 left-11 z-10">
        <ul class="space-y-4 mt-[53px]">
          <li class="text-lg">
            <router-link to="/procurement-dashboard" class="no-hover pl-3" active-class="font-semibold bg-white pl-3 pr-[117px] py-1 shadow-lg no-hover">
                Dashboard
            </router-link>
          </li>
          <li class="text-lg">
          ...
          <li class="text-lg">
            ...
            >
              <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButtonMain">
                <li>
                  <router-link to="/asse" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover" active-class="font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover">Sample</router-link>
                </li>
                <li>
                  <router-link to="/mov-in" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover" active-class="font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover">Sample</router-link>
                </li>
                <li>
                  <router-link to="/scrapp" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover" active-class="font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover">Sample</router-link>
                </li>
                <li>
                  <router-link to="/cs" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white no-hover" active-class="font-semibold bg-zinc-300 pr-[11px] py-1 shadow-lg no-hover">Sample</router-link>
                </li>
              </ul>
            </div>
          </li>
