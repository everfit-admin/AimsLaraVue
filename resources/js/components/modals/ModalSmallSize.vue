<template>
    <div class="w-[100%] absolute top-[30px] flex justify-center">
      <div v-show="isVisible" class="w-[600px] h-[380px] shadow-lg bg-white rounded-lg absolute z-50 mt-[120px] animate-bounceModal px-10 overflow-y-auto overflow-x-hidden" @click.self="close">
